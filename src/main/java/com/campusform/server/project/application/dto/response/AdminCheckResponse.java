...
public class AdminCheckResponse {
     ...
     * 회원이 존재하는 경우의 생성자
     */
    public static AdminCheckResponse success(Long userId, String nickname, String email) {
        return new AdminCheckResponse(true, userId, nickname, email, null);
    }
    ...
    public static AdminCheckResponse notFound(String email) {
        return new AdminCheckResponse(false, null, null, email,
