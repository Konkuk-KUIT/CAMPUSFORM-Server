...
public class RecruitingStageController {
     ...
     * 서류 단계 종료 및 프로젝트 종료
     *
     * 전제: 프로젝트 상태가 DOCUMENT_LOCKED 인 경우에만 가능합니다.
     */
    ...
    public ResponseEntity<ProjectResponse> completeDocument(@PathVariable Long projectId) {
        ProjectResponse response = recruitingStageService.completeDocument(projectId);
